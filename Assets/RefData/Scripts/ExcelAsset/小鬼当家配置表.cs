...
{
	//public List<TrapData> trap; // Replace 'EntityType' to an actual type that is serializable.
	...
	public List<EnemyBaseData> Enemy; // Replace 'EntityType' to an actual type that is serializable.
